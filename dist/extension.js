        ...
        try {
            ...
            for (const varName of varNames) {
                ...
                if (process.env.hasOwnProperty(varName)) {
                    ...
                    // Ask user what to do
                    const response = await vscode.window.showWarningMessage(`Environment variable "${varName}" already exists.\n\nCurrent value: ${currentValue}\nNew value: ${valueStr}\n\nDo you want to overwrite it?`, { modal: true }, 'Overwrite', 'Skip', 'Cancel Import');
...
module.exports.Type = __webpack_require__(20);
module.exports.Schema = __webpack_require__(19);
module.exports.FAILSAFE_SCHEMA = __webpack_require__(18);
module.exports.JSON_SCHEMA = __webpack_require__(17);
module.exports.CORE_SCHEMA = __webpack_require__(16);
module.exports.DEFAULT_SCHEMA = __webpack_require__(15);
module.exports.load                = loader.load;
module.exports.loadAll             = loader.loadAll;
module.exports.dump                = dumper.dump;
module.exports.YAMLException = __webpack_require__(13);

// Re-export all types in case user wants to create custom schema
module.exports.types = {
  binary:    __webpack_require__(30),
  float:     __webpack_require__(27),
  map:       __webpack_require__(23),
  null:      __webpack_require__(24),
  pairs:     __webpack_require__(32),
  set:       __webpack_require__(33),
  timestamp: __webpack_require__(28),
  bool:      __webpack_require__(25),
  int:       __webpack_require__(26),
  merge:     __webpack_require__(29),
  omap:      __webpack_require__(31),
  seq:       __webpack_require__(22),
  str:       __webpack_require__(21)
};
...
var YAMLException       = __webpack_require__(13);
var makeSnippet         = __webpack_require__(14);
var DEFAULT_SCHEMA      = __webpack_require__(15);
